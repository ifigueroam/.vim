...
set nu 									" Insert numeration in source
set expandtab    				" Convert tabs to spaces
map <S-y> :set nu <CR>
map <C-y> :set nonu <CR>
set ts=2		" Tabule two spaces
set sw=4
...
nmap <S-o> :NextColorScheme<CR>
nmap <S-i> :PrevColorScheme<CR>
nmap <S-p> :RandomColorScheme<CR>

" AIRLINE_POWERLINE_TMUX
